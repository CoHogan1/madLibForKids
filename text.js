NARRATOR: Once upon a time, there was a lonely Prince named...
1)
...
2)		wanted to help him find a princess that would make him happy.
...
3) 		, but it doesn't mean you're royalty.
...
NARRATOR: So each princess was asked to stay the night and the Queen placed a...
7)		under each mattress. All the princesses slept well except for one.
...
NARRATOR: So the prince went looking for the princess and found her crying in the...
10)
...
Fill in the Blank Sheet for “Princess and the Blank”
	Enter words in boxes below
1) An unusual name:

2) The name of a place:

3) The name of a Disney character:

4) The name of somewhere you'd place an ad:

5) A number:

6) A favorite food:

7) A different favorite food:

8) An adjective (a word that describes something):

9) A specific time on the clock:

10) An outdoor location:
